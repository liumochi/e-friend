	        ...
	        <div class="mag-inner">
			    <div class="col-md-8 mag-innert-left jghdl">
										...
										<div class="editor-pics">
										 <div class="col-md-3 item-pic">
										   <img src="assets/images/f2.jpg" class="img-responsive" alt=""/>
											...
											<div class="col-md-9 item-details">
												<h5 class="inner two"><a href="single.html">Bill Clinton , Politician.</a></h5>
												  <div class="td-post-date two">Combined with a handful.</div>
											 </div>
											<div class="clearfix"></div>
										</div>
										<div class="editor-pics">
										 <div class="col-md-3 item-pic">
										   <img src="../../assets/images/f3.jpg" class="img-responsive" alt=""/>
											...
											<div class="col-md-9 item-details">
												<h5 class="inner two"><a href="single.html">Andrew Ronalds , Politician.</a></h5>
												  <div class="td-post-date two">Combined with a handful</div>
											 </div>
											<div class="clearfix"></div>
										</div>
										<div class="editor-pics">
										 <div class="col-md-3 item-pic">
										   <img src="../../assets/images/f4.jpg" class="img-responsive" alt=""/>
											...
											<div class="col-md-9 item-details">
												<h5 class="inner two"><a href="single.html">Adelmir Santana , Politician.</a></h5>
												   <div class="td-post-date two">Combined with a handful.</div>
											 </div>
											<div class="clearfix"></div>
										</div>
					  ...
					  <div class="gallery">
							<div class="main-title-head">
							  <h3 class="tittle"><i class="glyphicon glyphicon-picture"></i>俱乐部</h3>
							</div>
				 ...
				 <div class="col-md-4 mag-inner-right">
				  <div class="connect">
				    <h4 class="side" ><i class="glyphicon glyphicon-hand-right" aria-hidden="true"></i>热门文章</h4>
					  <ul class="stay">
				    ...
				    <div class="modern">
				      <h4 class="side"><i class="glyphicon glyphicon-user" aria-hidden="true"></i>校内一角</h4>
					  <div id="example1">
				...
				<!-- requried-jsfiles-for owl -->
						...
						<!-- //requried-jsfiles-for owl -->
							 ...
							 <h4 class="side"><i class="glyphicon glyphicon-file" aria-hidden="true"></i>热门话题</h4>
								<div class="edit-pics">
										<div class="editor-pics">
										 <div class="col-md-3 item-pic">
										   <img src="assets/images/f4.jpg" class="img-responsive" alt=""/>
